...
public class IPv4ToLocationUtils {

    //使用腾讯的接口通过ip拿到城市信息
    private static final String KEY = "XXWBZ-PQ5EQ-4C35B-GWBZU-632WV-PQBOC";
    ...
    public static String getLocation(String ip) throws Exception {
        ...
        if ("query ok".equals(message)) {
            ...
            //  String district = (String) addressInfo.get("district");  //县
    ...
    public static String sendGet(String ip, String key) throws Exception {
        String result = "";
